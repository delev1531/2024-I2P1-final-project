...
void game_init(Game *self)
{
    ...
    fps = al_create_timer(0.5 / FPS);//1.0
...
bool game_update(Game *self)
{
    ...
    if (scene->scene_end)
    {
        ...
        case 0:
            ...
            break;
        case 1:
            create_scene(Menu1_L);
            break;
        case 2:
            create_scene(Menu2_L);
            break;
        case 3:
            create_scene(Menu3_L);
            break;
        case 4:
            create_scene(GameScene_L);
            break;
        case 5:
            printf("game end scene\n");
            create_scene(GameEnd_L);
            break;
        case -1:
            return false;
        default:
